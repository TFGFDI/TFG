        ...
        <form name="form_modificar" id="form_modificar" method="POST" action="../do.php">
			...
			<legend class="bloqueRedondo">Datos Personales</legend>
				...
				<div class="bloque_campoForumulario">
					...
					<input type="text" name="direccion"  value="<?php echo $fila['direccion']?>"  class="input_tamanhoMediano" tabindex="6"/>
				</div>
				<div class="bloque_campoForumulario">
				...
				<div class="bloque_campoForumulario">
					...
					<input type="text" name="ciudad" id="ciudad" value="<?php echo $fila['ciudad']?>"  class="input_tamanhoNormal" tabindex="8"/>
				</div>
				<div class="bloque_campoForumulario">
				...
				<div class="bloque_campoForumulario">
					...
					<input type="password" name="contrasena_antigua" id="contrasena_antigua"   value=""  class="input_tamanhoNormal" tabindex="11" />
				</div>
				<div class="bloque_campoForumulario">
					<label for="contrasena nueva">Contrase&ntilde;a nueva:</label>
					<input type="password" name="contrasena" id="contrasena" value="" class="input_tamanhoNormal" tabindex="12"/>
				</div>
				<div class="bloque_campoForumulario">
					<label for="contrasena nueva2">Confirmar contrase&ntilde;a nueva:</label>
					<input type="password" name="contrasena2" id="contrasena2" value="" class="input_tamanhoNormal" tabindex="13"/>
				</div>
